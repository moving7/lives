							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<p>
											<a class="btn btn-default btn-app radius-4" href="#">
												<i class="icon-cog bigger-230"></i>
												Default
												<span class="badge badge-pink">+3</span>
											</a>

											<a class="btn btn-app btn-primary no-radius" href="#">
											...
											<a class="btn btn-app btn-info btn-sm no-radius" href="#">
										...
										<h3 class="row-fluid header smaller lighter purple">
											...
											<span class="span5">
												<label class="pull-right inline">
													...
													<input type="checkbox" class="ace ace-switch ace-switch-5" checked="checked" id="id-button-borders">
													<span class="lbl"></span>
												</label>
											</span><!-- /span -->
										</h3>
								...
								<div class="row">
									<div class="col-sm-6">
										...
										<p>
											<button data-loading-text="Loading..." class="btn btn-success" type="button" id="loading-btn">Loading state</button>
											<button data-toggle="button" class="btn btn-primary" type="button">Single Toggle</button>
											<button data-toggle="button" class="btn btn-sm btn-danger" type="button">Small</button>
											<button data-toggle="button" class="btn btn-xs btn-info" type="button">Mini</button>
										</p>
										...
										<div>
											...
											<label data-toggle="button" class="btn btn-primary">
												<i class="icon-only icon-align-justify"></i>
											</label>
										</div>
									...
									<div class="col-sm-6">
										...
										<div class="btn-toolbar">
											...
											<div class="btn-group">
												<button class="btn btn-inverse btn-xs dropdown-toggle" data-toggle="dropdown">
													Inverse mini
													<span class="icon-caret-down icon-on-right"></span>
												</button>
										...
										<div class="btn-toolbar">
											...
											<div class="btn-group">
												...
												<button class="btn btn-sm btn-yellow dropdown-toggle" data-toggle="dropdown">
